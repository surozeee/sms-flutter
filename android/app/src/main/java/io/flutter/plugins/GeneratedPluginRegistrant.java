...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.example.social_sharing_plus.SocialSharingPlusPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin social_sharing_plus, com.example.social_sharing_plus.SocialSharingPlusPlugin", e);
    }
    try {
